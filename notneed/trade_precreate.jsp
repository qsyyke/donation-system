...
<%@ page import="com.yq.alipay.trade.config.Configs"%>
<%@ page import="com.yq.alipay.trade.model.builder.AlipayTradePrecreateRequestBuilder"%>
<%@ page import="com.yq.alipay.trade.service.AlipayTradeService" %>
<%@ page import="com.yq.alipay.trade.service.impl.AlipayTradeServiceImpl" %>
<%@ page import="com.yq.alipay.trade.utils.ZxingUtils" %>
<%@ page import="java.io.File" %>
<%@ page import="com.yq.alipay.trade.model.ExtendParams" %>
<%@ page import="com.yq.alipay.trade.model.GoodsDetail" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="com.yq.alipay.trade.model.result.AlipayF2FPrecreateResult" %>
